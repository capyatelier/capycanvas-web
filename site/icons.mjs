...
const paths = {
  ...
  book: '<path d="M12 5v15M3 4h5a4 4 0 0 1 4 2 4 4 0 0 1 4-2h5v14h-5a4 4 0 0 0-4 2 4 4 0 0 0-4-2H3Z"/>',
  circleCheck: '<circle cx="12" cy="12" r="9"/><path d="m7 12 3 3 7-7"/>',
  sprout: '<path d="M12 21v-9M12 15C4 15 3 9 3 6c6 0 9 3 9 9ZM12 12c0-7 4-10 9-10 0 6-3 10-9 10Z"/>',
  ipad: '<rect x="5" y="2" width="14" height="20" rx="2.5"/><path d="M10 18h4"/>',
  android: '<path d="M5 17V12a7 7 0 0 1 14 0v5ZM7 6 5 3m12 3 2-3M2 12v5m20-5v5M8 17v4m8-4v4"/><path d="M9 10h.01M15 10h.01" stroke-width="2.5"/>',
  linux: '<path d="M7 13c-1-2-1-5 0-8 2-4 8-4 10 0 1 3 1 6 0 8l3 5-4 2H8l-4-2ZM9 8h.01M15 8h.01M10 11l2 1 2-1M7 14l-2 3m12-3 2 3"/>',
