...
## Control the stroke and the whole layer separately
...
For a texture pass that needs separate adjustment, add another clipped layer above Hair. Keep it separate while comparing the effect by hiding and showing it. If you need a different brush response, start with the explanation of opacity, flow, and pressure in [Brush engine](/docs/advanced/brush-engine/).

## Revise an edge or color
